...
def start_trading(client,symbol, leverage=5,SL=10):
    ...
    try:
        ...
        return np.zeros((20,19)), [-2,0], message, 0, 0, 0, 0, 0, 0
        #return market_condition, prediction, message, direction, balance, balance on trade, entry price, take profit, stop loss
    ...
    try:
        ...
        if position_amount != 0:
            ...
            if len(open_orders) == 2:
                message = 'no problem'
                return np.zeros((20,19)), np.zeros((2,)), message, 0,0,0,0,0,0
                #return market_condition, prediction, message, direction, balance, balance on trade, entry price, take profit, stop loss
            ...
            if len(open_orders) == 1:
                ...
                if is_limit_order:  # Only TP remains
                    ...
                    return np.zeros((20,19)), np.zeros((2,)), message, direction, 0,amount*entry_price, entry_price, 0, StopLoss
                    #return market_condition, prediction, message, direction, balance, balance on trade, entry price, take profit, stop loss
                    ...
                    return np.zeros((20,19)), np.zeros((2,)), message, direction, 0, amount*entry_price, entry_price, TakeProfit, 0
                    #return market_condition, prediction, message, direction, balance, balance on trade, entry price, take profit, stop loss
            ...
            # no open order remains
                ...
                return np.zeros((20,19)), np.zeros((2,)), message, direction, 0, amount*entry_price, entry_price, TakeProfit, StopLoss
                #return market_condition, prediction, message, direction, balance, balance on trade, entry price, take profit, stop loss
